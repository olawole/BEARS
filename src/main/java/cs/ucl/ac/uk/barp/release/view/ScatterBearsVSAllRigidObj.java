...
public class ScatterBearsVSAllRigidObj extends ApplicationFrame {
...
//	List<ReleasePlan> dominatedSolutions;
     ...
     */ 
    public ScatterBearsVSAllRigidObj(String title, List<ReleasePlan> optimalSolutions, List<ReleasePlan> evolveSolutions,
	...
	public ScatterBearsVSAllRigidObj(String title, List<ReleasePlan> solutions, List<ReleasePlan> evolvePlan) {
    	super(title);
		// TODO Auto-generated constructor stub
	}

	public JFreeChart createChart(XYDataset data){
    	JFreeChart chart = ChartFactory.createScatterPlot(getTitle(), "Expected Effort Overrun", "Expected Net Present Value ('000 Pounds)", data);
