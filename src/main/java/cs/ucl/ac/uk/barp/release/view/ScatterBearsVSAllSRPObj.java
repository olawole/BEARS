...
public class ScatterBearsVSAllSRPObj extends ApplicationFrame {
...
//	List<ReleasePlan> dominatedSolutions;
     ...
     */ 
    public ScatterBearsVSAllSRPObj(String title, List<ReleasePlan> optimalSolutions, List<ReleasePlan> evolveSolutions,
	...
	public ScatterBearsVSAllSRPObj(String title, List<ReleasePlan> solutions, List<ReleasePlan> evolvePlan) {
    	super(title);
		// TODO Auto-generated constructor stub
	}

	public JFreeChart createChart(XYDataset data){
    	JFreeChart chart = ChartFactory.createScatterPlot(getTitle(), "Probability (All features delivered within effort capacity)", "Business Value Point", data);
