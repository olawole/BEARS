...
public class ScatterBearsRigidVBears extends ApplicationFrame {
...
//	List<ReleasePlan> dominatedSolutions;
     ...
     */
    public ScatterBearsRigidVBears(final String title, List<ReleasePlan> optimal, List<ReleasePlan> evolve) {
        super(title);
        //allSolutions = all;
